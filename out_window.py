...
class Ui_OutputDialog(QDialog):
    def __init__(self):
        ...
        self.url = 'http://sriwijaya87.com/absen_jetson.php'
            ...
            if self.ClockInButton.isChecked():
                ...
                with open('Attendance.csv', 'a') as f:
                        if (name != 'unknown'):
                            ...
                            x = requests.post(self.url, data=sendnama)
                            print(x.text)
    ...
    #Muncul pesan
    def showStatus(self, pesan: str):
        if pesan.__contains__('Absen DATANG'):
            self.StatusLabel.setText('Absen Masuk')
        elif pesan.__contains__('BELUM BOLEH PULANG'):
            self.StatusLabel.setText('Belum Boleh Pulang')
        else :
            self.StatusLabel.setText('Absen Pulang')
